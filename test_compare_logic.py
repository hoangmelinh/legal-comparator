...
class CompareLogicTests(unittest.TestCase):
    def test_numeric_detection_includes_percent_date_and_units(self):
        ...
        self.assertTrue(comparator.has_numeric_diff("Hạn đến 01/01/2024", "Hạn đến 02/01/2024"))
        self.assertTrue(comparator.has_numeric_diff("Khối lượng 10 kg", "Khối lượng 10 g"))

    def test_word_level_span_stays_tight_on_numeric_change(self):
        payload = comparator._build_minimal_changed_spans("Phí là 10 đồng", "Phí là 12 đồng")
        ...
        change_list = [
            {
                ...
                "changed_spans_a": [{"text": "A", "start": 0, "end": 1, "token_count": 1}],
                "changed_spans_b": [{"text": "B", "start": 0, "end": 1, "token_count": 1}],
            ...
            },
            {
                ...
                "changed_spans_a": [{"text": "Cũ", "start": 0, "end": 3, "token_count": 1}],
                "changed_spans_b": [{"text": "Mới", "start": 0, "end": 3, "token_count": 1}],
                "citation_anchor_a": None,
                "citation_anchor_b": None,
    ...
    def test_prepare_job_payload_uses_highlight_page_and_reindexes_ids(self):
        change_list = [
            ...
            },
            {
                ...
                "highlight_anchors_a": [{"page": 3, "bbox": [10, 20, 30, 40], "kind": "inline", "strike": True}],
                "highlight_anchors_b": [{"page": 4, "bbox": [11, 21, 31, 41], "kind": "inline", "strike": False}],
            },
            {
                "article": "Dieu 2",
                "status": "REMOVED",
                ...
                "highlight_anchors_a": [{"page": 7, "bbox": [1, 2, 3, 4], "kind": "block", "strike": True}],
                "highlight_anchors_b": [],
            },
        ]
    ...
    def test_clause_highlights_mark_block_and_strike(self):
        provenance = {
            "anchors": [
                {"page": 2, "bbox": [54, 100, 420, 116], "block_index": 2, "line_index": 0},
                {"page": 2, "bbox": [54, 118, 430, 134], "block_index": 2, "line_index": 1},
            ]
        }
    ...
    def test_modified_highlight_mode_switches_by_scope(self):
        token_stats_small = {"tokens_a": [1] * 12, "tokens_b": [1] * 12, "changed_a": 1, "changed_b": 1}
        payload_small = {"changed_spans_a": [{"text": "10"}], "changed_spans_b": [{"text": "12"}]}
        self.assertFalse(comparator._should_use_block_highlight_for_modified(True, token_stats_small, payload_small))
        self.assertFalse(comparator._should_use_block_highlight_for_modified(False, token_stats_small, payload_small))

        token_stats_big = {"tokens_a": [1] * 12, "tokens_b": [1] * 12, "changed_a": 7, "changed_b": 7}
        payload_big = {"changed_spans_a": [{"text": "A"}] * 6, "changed_spans_b": [{"text": "B"}] * 6}
        self.assertTrue(comparator._should_use_block_highlight_for_modified(False, token_stats_big, payload_big))
